...
export default function Orb({ hue = 0, hoverIntensity = 0.2, rotateOnHover = true, forceHoverState = false, backgroundColor = "#000000" }: OrbProps) {
  ...
  `;
    ...
    return <div ref={ctnDom} className="absolute h-full w-full" />;
}
