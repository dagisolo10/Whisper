    ...
    return (
        <div className="w-full space-y-4">
            <Button
                ...
                variant="outline"
                className="h-10 w-full gap-3 border-white/10 bg-white/5 text-sm font-semibold text-white hover:bg-white/10"
                disabled={isLoading || !isLoaded}
            >
                <GoogleIcon />
                <p>{isLoading ? "Connecting to Google..." : "Continue with Google"}</p>
...
function GoogleIcon() {
    return (
        <svg viewBox="0 0 128 128" className="size-4" aria-hidden="true">
            <path
                fill="#fff"
