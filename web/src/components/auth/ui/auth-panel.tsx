...
export default function AuthPanel({ title, description, children, redirect, className }: AuthPanelProps) {
    return (
        <section className={cn("relative flex w-full flex-col overflow-hidden rounded-4xl border border-white/10 p-6 shadow-2xl shadow-black/20 backdrop-blur", className)}>
            ...
            <div className="mx-auto flex w-full max-w-xl flex-1 flex-col justify-center py-8">
                <div className="mb-8 space-y-2 text-center">
                    <p className="text-[10px] font-semibold tracking-[0.35em] text-sky-200 uppercase">Whisper Auth</p>
