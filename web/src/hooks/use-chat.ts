    ...
    const handleSendMessage = useCallback(
        async (e: SyntheticEvent<HTMLFormElement>) => {
            ...
            const sendTextMessage = async () => {
                ...
                const payload: MessagePayload = { messageType: "Text", roomId: activeRoom.id, textContent: trimmedMessage };
        ...
        [activeRoom, clearPendingImages, isSending, lastToken, message, pendingImages, sendMessage, socket, user],
    );
